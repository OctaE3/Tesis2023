...
public class Controladora_Insumo {
    ...
    public ResponseEntity<Carne> modificarCarne(@RequestBody Carne carne, @PathVariable(value="carneId") Long carneId){
    ...
    public ResponseEntity<?> buscarControlDeInsumosPorId(@PathVariable(value="controlDeInsumosId") Long controlDeInsumosId){
    ...
    public ResponseEntity<Control_de_Insumos> modificarCarne(@RequestBody Control_de_Insumos controlDeInsumos, @PathVariable(value="controlDeInsumosId") Long controlDeInsumosId){
    ...
    public ResponseEntity<Lote> modificarLote(@RequestBody Lote lote, @PathVariable(value="loteId") Long loteId){
        ...
        if(loteData.isPresent()){
            loteData.get().setLoteCodigo(lote.getLoteCodigo());
            loteData.get().setLoteProductos(lote.getLoteProductos());
    ...
    public ResponseEntity<?> buscarcontrolDeNitratoPorId(@PathVariable(value="controlDeNitratoId") Long controlDeNitratoId){
    ...
    public ResponseEntity<PControl_de_Nitrato> modificarControlDeNitrato(@RequestBody PControl_de_Nitrato controlDeNitrato, @PathVariable(value="controlDeNitratoId") Long controlDeNitratoId){
        ...
        if(controlDeNitratoData.isPresent()){
            ...
            controlDeNitratoData.get().setControlDeNitratoCantidadUtilizada(controlDeNitrato.getControlDeNitratoCantidadUtilizada());
            controlDeNitratoData.get().setControlDeNitratoProductoLote(controlDeNitrato.getControlDeNitratoProductoLote());
            controlDeNitratoData.get().setControlDeNitratoStock(controlDeNitrato.getControlDeNitratoStock());
            controlDeNitratoData.get().setControlDeNitratoObservaciones(controlDeNitrato.getControlDeNitratoObservaciones());
            controlDeNitratoData.get().setControlDeNitratoResponsable(controlDeNitrato.getControlDeNitratoResponsable());
    ...
    public ResponseEntity<?> buscarControlDeNitritoPorId(@PathVariable(value="controlDeNitritoId") Long controlDeNitritoId){
    ...
    public ResponseEntity<PControl_de_Nitrito> modificarControlDeNitrito(@RequestBody PControl_de_Nitrito controlDeNitrito, @PathVariable(value="controlDeNitritoId") Long controlDeNitritoId){
        ...
        if(controlDeNitritoData.isPresent()){
            ...
            controlDeNitritoData.get().setControlDeNitritoProductoLote(controlDeNitrito.getControlDeNitritoProductoLote());
            controlDeNitritoData.get().setControlDeNitritoCantidadUtilizada(controlDeNitrito.getControlDeNitritoCantidadUtilizada());
            controlDeNitritoData.get().setControlDeNitritoStock(controlDeNitrito.getControlDeNitritoStock());
            controlDeNitritoData.get().setControlDeNitritoObservaciones(controlDeNitrito.getControlDeNitritoObservaciones());
            controlDeNitritoData.get().setControlDeNitritoResponsable(controlDeNitrito.getControlDeNitritoResponsable());
    ...
    public ResponseEntity<?> buscarcontrolDeProductosQuimicosPorId(@PathVariable(value="controlDeProductosQuimicosId") Long controlDeProductosQuimicosId){
        Optional<PControl_de_Productos_Quimicos> controlDeProductosQuimicos = controlDeProductosQuimicosServicioImpl.findById(controlDeProductosQuimicosId);
    ...
    public ResponseEntity<?> agregarControlDeProductosQuimicos(@RequestBody PControl_de_Productos_Quimicos controlDeProductosQuimicos){
        try{
            return ResponseEntity.status(HttpStatus.CREATED).body(controlDeProductosQuimicosServicioImpl.save(controlDeProductosQuimicos));
        }
        catch(Exception e){
            HashMap<String, String> error = new HashMap<>();
            error.put("error", e.getMessage());
    ...
    public ResponseEntity<HttpStatus> eliminarControlDeProductosQuimicos(@PathVariable Long controlDeProductosQuimicosId){
        try{
    ...
    public ResponseEntity<PControl_de_Productos_Quimicos> modificarControlDeProductosQuimicos(@RequestBody PControl_de_Productos_Quimicos controlDeProductosQuimicos, @PathVariable(value="controlDeProductosQuimicosId") Long controlDeProductosQuimicosId){
        Optional<PControl_de_Productos_Quimicos> controlDeProductosQuimicosData = controlDeProductosQuimicosServicioImpl.findById(controlDeProductosQuimicosId);
        if(controlDeProductosQuimicosData.isPresent()){
            controlDeProductosQuimicosData.get().setControlDeProductosQuimicosFecha(controlDeProductosQuimicos.getControlDeProductosQuimicosFecha());
            controlDeProductosQuimicosData.get().setControlDeProductosQuimicosLote(controlDeProductosQuimicos.getControlDeProductosQuimicosLote());
            controlDeProductosQuimicosData.get().setControlDeProductosQuimicosMotivoDeRechazo(controlDeProductosQuimicos.getControlDeProductosQuimicosMotivoDeRechazo());
            controlDeProductosQuimicosData.get().setControlDeProductosQuimicosProductoQuimico(controlDeProductosQuimicos.getControlDeProductosQuimicosProductoQuimico());
            controlDeProductosQuimicosData.get().setControlDeProductosQuimicosProveedor(controlDeProductosQuimicos.getControlDeProductosQuimicosProveedor());
            controlDeProductosQuimicosData.get().setControlDeProductosQuimicosResponsable(controlDeProductosQuimicos.getControlDeProductosQuimicosResponsable());
            return new ResponseEntity<>(controlDeProductosQuimicosServicioImpl.save(controlDeProductosQuimicosData.get()), HttpStatus.OK);
        }else{
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
    }
    ...
    public ResponseEntity<?> buscarDiariaDeProduccionPorId(@PathVariable(value="diariaDeProduccionId") Long diariaDeProduccionId){
        Optional<PDiaria_de_Produccion> diariaDeProduccion = diariaDeProduccionServicioImpl.findById(diariaDeProduccionId);
    ...
    public ResponseEntity<?> agregarDiariaDeProduccion(@RequestBody PDiaria_de_Produccion diariaDeProduccion){
        try{
            return ResponseEntity.status(HttpStatus.CREATED).body(diariaDeProduccionServicioImpl.save(diariaDeProduccion));
        }
        catch(Exception e){
            HashMap<String, String> error = new HashMap<>();
            error.put("error", e.getMessage());
    ...
    public ResponseEntity<PDiaria_de_Produccion> modificarDiariaDeProduccion(@RequestBody PDiaria_de_Produccion diariaDeProduccion, @PathVariable(value="diariaDeProduccionId") Long diariaDeProduccionId){
        Optional<PDiaria_de_Produccion> diariaDeProduccionData = diariaDeProduccionServicioImpl.findById(diariaDeProduccionId);
        if(diariaDeProduccionData.isPresent()){
            diariaDeProduccionData.get().setDiariaDeProduccionAditivos(diariaDeProduccion.getDiariaDeProduccionAditivos());
            diariaDeProduccionData.get().setDiariaDeProduccionCantidadProducida(diariaDeProduccion.getDiariaDeProduccionCantidadProducida());
            diariaDeProduccionData.get().setDiariaDeProduccionEnvasado(diariaDeProduccion.getDiariaDeProduccionEnvasado());
            diariaDeProduccionData.get().setDiariaDeProduccionFecha(diariaDeProduccion.getDiariaDeProduccionFecha());
            diariaDeProduccionData.get().setDiariaDeProduccionFechaVencimiento(diariaDeProduccion.getDiariaDeProduccionFechaVencimiento());
            diariaDeProduccionData.get().setDiariaDeProduccionInsumosCarnicos(diariaDeProduccion.getDiariaDeProduccionInsumosCarnicos());
            diariaDeProduccionData.get().setDiariaDeProduccionLote(diariaDeProduccion.getDiariaDeProduccionLote());
            diariaDeProduccionData.get().setDiariaDeProduccionProducto(diariaDeProduccion.getDiariaDeProduccionProducto());
            diariaDeProduccionData.get().setDiariaDeProduccionResponsable(diariaDeProduccion.getDiariaDeProduccionResponsable());
            return new ResponseEntity<>(diariaDeProduccionServicioImpl.save(diariaDeProduccionData.get()), HttpStatus.OK);
        }else{
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
    }
    ...
    public ResponseEntity<?> buscarRecepcionDeMateriasPrimasCarnicasPorId(@PathVariable(value="recepcionDeMateriasPrimasCarnicasId") Long recepcionDeMateriasPrimasCarnicasId){
        Optional<PRecepcion_de_Materias_Primas_Carnicas> recepcionDeMateriasPrimasCarnicas = recepcionDeMateriasPrimasCarnicasServicioImpl.findById(recepcionDeMateriasPrimasCarnicasId);
    ...
    public ResponseEntity<?> agregarRecepcionDeMateriasPrimasCarnicas(@RequestBody PRecepcion_de_Materias_Primas_Carnicas recepcionDeMateriasPrimasCarnicas){
        try{
            return ResponseEntity.status(HttpStatus.CREATED).body(recepcionDeMateriasPrimasCarnicasServicioImpl.save(recepcionDeMateriasPrimasCarnicas));
        }
        catch(Exception e){
            HashMap<String, String> error = new HashMap<>();
            error.put("error", e.getMessage());
    ...
    public ResponseEntity<HttpStatus> eliminarRecepcionDeMateriasPrimasCarnicas(@PathVariable Long recepcionDeMateriasPrimasCarnicasId){
        try{
    ...
    public ResponseEntity<PRecepcion_de_Materias_Primas_Carnicas> modificarRecepcionDeMateriasPrimasCarnicas(@RequestBody PRecepcion_de_Materias_Primas_Carnicas recepcionDeMateriasPrimasCarnicas, @PathVariable(value="recepcionDeMateriasPrimasCarnicasId") Long recepcionDeMateriasPrimasCarnicasId){
        Optional<PRecepcion_de_Materias_Primas_Carnicas> recepcionDeMateriasPrimasCarnicasData = recepcionDeMateriasPrimasCarnicasServicioImpl.findById(recepcionDeMateriasPrimasCarnicasId);
        if(recepcionDeMateriasPrimasCarnicasData.isPresent()){
            recepcionDeMateriasPrimasCarnicasData.get().setRecepcionDeMateriasPrimasCarnicasFecha(recepcionDeMateriasPrimasCarnicas.getRecepcionDeMateriasPrimasCarnicasFecha());
            recepcionDeMateriasPrimasCarnicasData.get().setRecepcionDeMateriasPrimasCarnicasMotivoDeRechazo(recepcionDeMateriasPrimasCarnicas.getRecepcionDeMateriasPrimasCarnicasMotivoDeRechazo());
            recepcionDeMateriasPrimasCarnicasData.get().setRecepcionDeMateriasPrimasCarnicasPaseSanitario(recepcionDeMateriasPrimasCarnicas.getRecepcionDeMateriasPrimasCarnicasPaseSanitario());
            recepcionDeMateriasPrimasCarnicasData.get().setRecepcionDeMateriasPrimasCarnicasProductos(recepcionDeMateriasPrimasCarnicas.getRecepcionDeMateriasPrimasCarnicasProductos());
            recepcionDeMateriasPrimasCarnicasData.get().setRecepcionDeMateriasPrimasCarnicasProveedor(recepcionDeMateriasPrimasCarnicas.getRecepcionDeMateriasPrimasCarnicasProveedor());
            recepcionDeMateriasPrimasCarnicasData.get().setRecepcionDeMateriasPrimasCarnicasResponsable(recepcionDeMateriasPrimasCarnicas.getRecepcionDeMateriasPrimasCarnicasResponsable());
            recepcionDeMateriasPrimasCarnicasData.get().setRecepcionDeMateriasPrimasCarnicasTemperatura(recepcionDeMateriasPrimasCarnicas.getRecepcionDeMateriasPrimasCarnicasTemperatura());
            return new ResponseEntity<>(recepcionDeMateriasPrimasCarnicasServicioImpl.save(recepcionDeMateriasPrimasCarnicasData.get()), HttpStatus.OK);
        }else{
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
    }
    ...
    public ResponseEntity<Producto> modificarProducto(@RequestBody Producto producto, @PathVariable(value="productoId") Long productoId){
