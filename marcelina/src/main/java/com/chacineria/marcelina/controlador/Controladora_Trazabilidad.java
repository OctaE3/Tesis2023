...
public class Controladora_Trazabilidad {
    ...
    public ResponseEntity<?> agregarAnualDeInsumosCarnicos() {
        try {
            return ResponseEntity.status(HttpStatus.CREATED)
                    .body(anualDeInsumosCarnicosServicioImpl.saveAnualDeInsumosCarnicosAutomatico());
        } catch (Exception e) {
    ...
    public ResponseEntity<PAnual_de_Insumos_Carnicos> modificarAnualDeInsumosCarnicos(
        ...
        if (anualDeInsumosCarnicosData.isPresent()) {
            anualDeInsumosCarnicosData.get()
                    .setAnualDeInsumosCarnicosAnio(anualDeInsumosCarnicos.getAnualDeInsumosCarnicosAnio());
            ...
            anualDeInsumosCarnicosData.get()
                    .setAnualDeInsumosCarnicosHigado(anualDeInsumosCarnicos.getAnualDeInsumosCarnicosHigado());
            ...
            anualDeInsumosCarnicosData.get()
                    .setAnualDeInsumosCarnicosMes(anualDeInsumosCarnicos.getAnualDeInsumosCarnicosMes());
            ...
            return new ResponseEntity<>(anualDeInsumosCarnicosServicioImpl.save(anualDeInsumosCarnicosData.get()),
                    HttpStatus.OK);
        } else {
        ...
        try {
            ...
            if (dto.getExpedicionDeProducto() != null && dto.getListaCantidad() != null) {
                return ResponseEntity.status(HttpStatus.CREATED).body(expedicionDeProductoServicioImpl
                        .saveExpCantidad(dto.getExpedicionDeProducto(), dto.getListaCantidad()));
            } else {
                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
    ...
    public ResponseEntity<PExpedicion_de_Producto> modificarExpedicionDeProducto(
        ...
        if (expedicionDeProductoData.isPresent()) {
            expedicionDeProductoData.get()
                    .setExpedicionDeProductoCliente(expedicionDeProducto.getExpedicionDeProductoCliente());
            expedicionDeProductoData.get()
                    .setExpedicionDeProductoDocumento(expedicionDeProducto.getExpedicionDeProductoDocumento());
            expedicionDeProductoData.get()
                    .setExpedicionDeProductoFecha(expedicionDeProducto.getExpedicionDeProductoFecha());
            expedicionDeProductoData.get()
                    .setExpedicionDeProductoLotes(expedicionDeProducto.getExpedicionDeProductoLotes());
            expedicionDeProductoData.get()
                    .setExpedicionDeProductoCantidad(expedicionDeProducto.getExpedicionDeProductoCantidad());
            expedicionDeProductoData.get()
                    .setExpedicionDeProductoProductos(expedicionDeProducto.getExpedicionDeProductoProductos());
            return new ResponseEntity<>(expedicionDeProductoServicioImpl.save(expedicionDeProductoData.get()),
                    HttpStatus.OK);
        } else {
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<PMonitoreo_de_SSOP_Operativo> modificarCarne(
        ...
        if (monitoreoDeSSOPOperativoData.isPresent()) {
            ...
            monitoreoDeSSOPOperativoData.get()
                    .setMonitoreoDeSSOPOperativoArea(monitoreoDeSSOPOperativo.getMonitoreoDeSSOPOperativoArea());
            monitoreoDeSSOPOperativoData.get()
                    .setMonitoreoDeSSOPOperativoFecha(monitoreoDeSSOPOperativo.getMonitoreoDeSSOPOperativoFecha());
            ...
            return new ResponseEntity<>(monitoreoDeSSOPOperativoServicioImpl.save(monitoreoDeSSOPOperativoData.get()),
                    HttpStatus.OK);
        } else {
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<?> agregarMonitoreoDeSSOPPreOperativo(
        ...
        try {
            return ResponseEntity.status(HttpStatus.CREATED)
                    .body(monitoreoDeSSOPPreOperativoServicioImpl.save(monitoreoDeSSOPPreOperativo));
        } catch (Exception e) {
            HashMap<String, String> error = new HashMap<>();
            error.put("error", e.getMessage());
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(error);
    ...
    public ResponseEntity<PMonitoreo_de_SSOP_PreOperativo> modificarMonitoreoDeSSOPPreOperativo(
        ...
        if (monitoreoDeSSOPPreOperativoData.isPresent()) {
            ...
            return new ResponseEntity<>(
                    monitoreoDeSSOPPreOperativoServicioImpl.save(monitoreoDeSSOPPreOperativoData.get()), HttpStatus.OK);
        } else {
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
    }
    ...
    public ResponseEntity<PResumen_de_Trazabilidad> modificarResumenDeTrazabilidad(
        ...
        if (resumenDeTrazabilidadData.isPresent()) {
            ...
            resumenDeTrazabilidadData.get()
                    .setResumenDeTrazabilidadDestino(resumenDeTrazabilidad.getResumenDeTrazabilidadDestino());
            resumenDeTrazabilidadData.get()
                    .setResumenDeTrazabilidadFecha(resumenDeTrazabilidad.getResumenDeTrazabilidadFecha());
            resumenDeTrazabilidadData.get()
                    .setResumenDeTrazabilidadLote(resumenDeTrazabilidad.getResumenDeTrazabilidadLote());
            ...
            resumenDeTrazabilidadData.get()
                    .setResumenDeTrazabilidadProducto(resumenDeTrazabilidad.getResumenDeTrazabilidadProducto());
            resumenDeTrazabilidadData.get()
                    .setResumenDeTrazabilidadResponsable(resumenDeTrazabilidad.getResumenDeTrazabilidadResponsable());
            return new ResponseEntity<>(resumenDeTrazabilidadServicioImpl.save(resumenDeTrazabilidadData.get()),
                    HttpStatus.OK);
        } else {
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
