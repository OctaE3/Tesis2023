...
import { createTheme, Typography, ThemeProvider, Avatar, Grid, ListSubheader } from '@material-ui/core';
...
const sections = [
  ...
  {
    title: 'Control de alarma lumínica y sonora de cloro',
    open: section7Open,
  ...
  {
    title: 'Control de limpieza y desinfeccion de depositos de agua y cañerias',
    open: section9Open,
  ...
  {
    title: 'Control de productos quimicos',
    open: section17Open,
  ...
  },
  {
    ...
    links: [
      { to: '/resumen-de-trazabilidad', text: 'Añadir' },
...
return (
  <ThemeProvider theme={theme}>
    <div className={classes.root}>
      ...
      >
        <List>
          <ListItem button component={Link} to="/inicio" onClick={handleDrawerClose}>
