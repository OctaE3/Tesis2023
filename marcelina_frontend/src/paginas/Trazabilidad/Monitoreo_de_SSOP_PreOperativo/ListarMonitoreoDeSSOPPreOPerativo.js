...
function ListarMonitoreoDeSSOPPreOPerativo() {
  ...
  const tableHeadCells = [
    ...
    { id: 'monitoreoDeSSOPPreOperativoArea', numeric: false, disablePadding: false, label: 'Área' },
  ...
  const handleEditMont = (rowData) => {
    const id = rowData.Id;
    navigate(`/modificar-monitoreo-de-ssop-pre-operativo/${id}`);
  };

  const handleDeleteMont = (rowData) => {
    const id = rowData.Id;
    axios.delete(`/borrar-monitoreo-de-ssop-pre-operativo/${id}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem('token')}`,
                ...
                <DialogContentText className={classes.text}>
                  ...
                  <span>
                    <ul>
                      ...
                      <li>
                        <span className={classes.liTitleBlue}>Sector</span>: En este campo se puede seleccionar un sector y filtrar los registros por ese sector.
                      </li>
                      <li>
                  ...
                  <span>
                    <ul>
                      ...
                      <li>
                        <span className={classes.liTitleRed}>Sector</span>: En esta columna se muestra el sector en el que se realizó el monitoreo.
                      </li>
                      <li>
